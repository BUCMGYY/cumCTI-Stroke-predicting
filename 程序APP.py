...
# 加载保存的随机森林模型
model = joblib.load('rf_stroke_model.pkl')

# ===================== 你的范围与顺序（直接用你刚输出的） =====================
feature_ranges = {
    'cumCTI': {'type': 'numerical', 'min': 19.6991388, 'max': 37.51311244, 'default': 20},
...
# Streamlit 界面
st.title("CumCTI: Predicting Future Stroke Progression with SHAP Visualization")
